...
When pulling the docker image, note that using the copy link from the home page (`docker pull bwdesigngroup/ignition-docker`) will automatically pull the most recent version of Ignition configured in the image. For example `:latest` may pull version `8.1.28` as of the time of writing.
...
### Example docker-compose file
	...
	services:
	  gateway:
		  image: bwdesigngroup/ignition-docker:8.1.28
		  ports:
		  - 80:8088
